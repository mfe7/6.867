...
\begin{abstract}
This is Machine Learning homework 1. Topics are gradient descent, linear basis function regression, ridge regression, sparsity and LASSO. All work has been done in Python.
\end{abstract}
